...
\begin{tabular}[c]{@{}l@{}}Esparta prestigia derrotas trincadas\\ legais problemáticas\end{tabular} & \begin{tabular}[c]{@{}l@{}}Eppappa ppeppipia peppopap\\ ppippapap pepaip ppoppepápipap\end{tabular} \\ \hline
\end{tabular}
	\caption{Questão B}
	\label{tabela2}
\end{table}
